define(function(require, exports, module) {
  ...
  module.exports = {
    ...
    _configText() {
      $('div h5.mgmt_title').text('网吧广告名称统计列表');
  ...
  function f_getWhere() {
    ...
    var clause = function(rowdata, rowindex) {
      ...
      var nameSearch = name ? (rowdata.Name.indexOf(name) > -1) : true;
      var alliance = $('select.select_alliance').val();
          alliance = alliance ? rowdata.OwnedAlliance == alliance : true;
      return (rowDateM >= startedAtM && rowDateM <= endedAtM && nameSearch && alliance);
    };
    return clause;
  };
  /*
