define(function(require, exports, module) {
  ...
  module.exports = {
    ...
    _configText() {
      $('div h5.mgmt_title').text('广告名称统计列表');
  ...
  function f_getWhere() {
    ...
    var clause = function(rowdata, rowindex) {
      ...
      var name = $('select.select_name').val();
      var nameSearch = name ? (name == rowdata.Name) : true;
      return (rowDateM >= startedAtM && rowDateM <= endedAtM && nameSearch);
    };
    return clause;
  };
  /*
